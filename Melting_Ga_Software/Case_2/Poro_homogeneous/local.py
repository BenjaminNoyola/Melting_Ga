...
#    tau_v = 0.5 + (0.1*H*math.sqrt(3.0*0.0208))/(math.sqrt(8.409e5))    
    if f_lloc[0] >= 0.5:    
        tau_v = 0.5069736489899809                                             #HHHHHHHHHHHHHHHH
    else:
        tau_v = 0.5
...
#    tau_v = 0.5 + (0.1*H*math.sqrt(3.0*0.0208))/(math.sqrt(8.409e5)) 
    if f_lloc[0] >= 0.5:    
        tau_v = 0.5069736489899809                                             #HHHHHHHHHHHHHHHHHHHHHHH
    else:
        tau_v = 0.5   
...
def calc_Floc(fl_PCMloc, uxloc, uyloc, cfloc, vlloc, Gloc, TFloc, Fxloc, Fyloc, i, j):
...
def calc_neqloc(Tloc, uxloc, uyloc, neqloc):
    ...
    if Tloc[0] >= 29.78:
        neqloc[0] = Tloc[0]
        neqloc[1] = uxloc[0]*Tloc[0]/0.8604
        neqloc[2] = uyloc[0]*Tloc[0]/0.8604
        neqloc[3] = w_test*Tloc[0]  
        neqloc[4] = 0.0   
    else:
        neqloc[0] = Tloc[0]
        neqloc[1] = uxloc[0]*Tloc[0]/0.8352
...
#    tau_v = 0.5 + (0.1*H*math.sqrt(3.0*0.0208))/(math.sqrt(8.409e5))
#    if f_lloc[0] >= 0.5:    
#        tau_v = 0.5069736489899809
#    else:
#        tau_v = 0.5   
    tau_v = 0.5069736489899809                                                 #HHHHHHHHHHHHHHHHHH
#    tau_v = 0.5
...
def calc_Ssurceloc(Ssurceloc, f_lloc, f_2lloc, Tloc):
    ...
    if Tloc[0] > 29.78:
        Ssurceloc[0] = -((poros*La)/(0.8604*Cpl))*(f_lloc[0] - f_2lloc[0])/1.0
        Ssurceloc[1] = 0.0
        Ssurceloc[2] = 0.0
        Ssurceloc[3] = -w_test*((poros*La)/(0.8604*Cpl))*(f_lloc[0] - f_2lloc[0])/1.0 
        Ssurceloc[4] = 0.0
    else:
        Ssurceloc[0] = -((poros*La)/(0.8352*Cpl))*(f_lloc[0] - f_2lloc[0])/1.0
        Ssurceloc[1] = 0.0
        Ssurceloc[2] = 0.0
        Ssurceloc[3] = -w_test*((poros*La)/(0.8352*Cpl))*(f_lloc[0] - f_2lloc[0])/1.0 
        Ssurceloc[4] = 0.0
