...
#########################################
# Plot temperature field and streamlines 
#########################################
...
#################################################
# Import textfiles we want to represent
#################################################
...
plt.figure()
cp = plt.contour(X, Y, strf_, cmap='gist_yarg')
...
plt.xlabel('X')
plt.ylabel('Y')
cs1 = plt.contourf((T_), 350, cmap='coolwarm')
plt.colorbar()
plt.show()
